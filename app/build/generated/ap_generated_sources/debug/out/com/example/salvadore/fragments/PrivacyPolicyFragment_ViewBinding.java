...
public class PrivacyPolicyFragment_ViewBinding implements Unbinder {
  ...
  public PrivacyPolicyFragment_ViewBinding(PrivacyPolicyFragment target, View source) {
    ...
    target.frame9 = Utils.findRequiredViewAsType(source, R.id.frame9, "field 'frame9'", FrameLayout.class);
    target.frame10 = Utils.findRequiredViewAsType(source, R.id.frame10, "field 'frame10'", FrameLayout.class);
    target.frame11 = Utils.findRequiredViewAsType(source, R.id.frame11, "field 'frame11'", FrameLayout.class);
    target.frame12 = Utils.findRequiredViewAsType(source, R.id.frame12, "field 'frame12'", FrameLayout.class);
    ...
    target.textView10 = Utils.findRequiredViewAsType(source, R.id.textView10, "field 'textView10'", TextView.class);
